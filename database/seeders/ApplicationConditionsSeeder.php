...
class ApplicationConditionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $merchant_2_conditions = [
            ['merchant_id' => 2, 'store_id' => 3, 'duration' => 6, 'discount' => 10],
            ['merchant_id' => 2, 'store_id' => 4, 'duration' => 12, 'commission' => 35],
        ];
        ...
        $merchant_3_conditions = [
            ...
            ['merchant_id' => 3, 'store_id' => 5, 'duration' => 9, 'commission' => 34],
            ['merchant_id' => 3, 'store_id' => 5, 'duration' => 12, 'commission' => 39],
            ['merchant_id' => 3, 'store_id' => 5, 'duration' => 15, 'discount' => 10],
        ];
