...
final class StoreNotificationDTO extends AbstractEntity
{
    /**
     * @param NotificationRecipientDTO[] $recipients
     */
    public function __construct(
        ...
        private ?bool $all_merchants = null,
     ...
     * @return bool|null
     */
    public function getAllMerchants(): ?bool
    {
        return $this->all_merchants;
    }

    /**
     * @return NotificationRecipientDTO[]|null
     */
    ...
    public static function fromArray(array $data): static
    {
        return  new static(
            ...
            all_merchants: self::parseNullableBool($data['all_merchants']),
            recipients: self::parseNullableEntityList(NotificationRecipientDTO::class, $data['recipients']),
        );
    }
    ...
    public function jsonSerialize()
    {
        return  [
            ...
            'all_merchants' => $this->all_merchants,
