...
class SmsMessages
{
    public static function onAuthentication(int $code): string
    {
    ...
    public static function onFinishedProblemCases(string $name, int $problem_case_id): string
    {
    ...
    public static function onNewProblemCases(string $name, int $problem_case_id): string
    {
