...
use App\Http\Controllers\ApiPrmGateway\App\AppController;
use App\Http\Controllers\ApiPrmGateway\App\CountersController;
use App\Http\Controllers\ApiPrmGateway\Comments\CommentsController;
use App\Http\Controllers\ApiPrmGateway\Complaints\ComplaintsController;
use App\Http\Controllers\ApiPrmGateway\Merchants\AdditionalAgreementsController;
use App\Http\Controllers\ApiPrmGateway\Merchants\ApplicationConditionsController;
use App\Http\Controllers\ApiPrmGateway\Merchants\AzoMerchantAccessesController;
use App\Http\Controllers\ApiPrmGateway\Merchants\MerchantFilesController;
use App\Http\Controllers\ApiPrmGateway\Merchants\MerchantInfoController;
use App\Http\Controllers\ApiPrmGateway\Merchants\MerchantRequestsController;
use App\Http\Controllers\ApiPrmGateway\Merchants\MerchantsController;
use App\Http\Controllers\ApiPrmGateway\Merchants\MerchantTagController;
use App\Http\Controllers\ApiPrmGateway\ProblemCases\ProblemCasesController;
use App\Http\Controllers\ApiPrmGateway\ProblemCases\ProblemCaseTagsController;
use App\Http\Controllers\ApiPrmGateway\Stores\NotificationsController;
use App\Http\Controllers\ApiPrmGateway\Stores\StoresController;
...
Route::prefix('merchants')
    ->group(function () {
        ...
        Route::match(['put', 'patch'], '/{id}/toggle-integration', [MerchantsController::class, 'toggleIntegration']);
